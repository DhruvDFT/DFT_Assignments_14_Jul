# app.py (Part 1 - Updated with DFT additions)
import os
import hashlib
...
def init_data():
    ...
    # 21 Engineers (18 original + 3 DFT)
    engineer_data = [
        ('eng001', 'Kranthi'),
        ('eng002', 'Neela'),
        ('eng003', 'Bhanu'),
...
# Questions - 18 per topic (Physical Design + DFT)
QUESTIONS = {
    "sta": [
    ...
    "dft": [
        "What is Design for Test (DFT)? Why is DFT essential in modern chip design?",
        "Explain scan chain methodology. How does scan testing work?",
        "What is the difference between combinational and sequential ATPG?",
        "Your design has 85% fault coverage. List 3 methods to improve fault coverage.",
        "What is stuck-at fault model? Explain stuck-at-0 and stuck-at-1 faults.",
        "Describe transition delay fault model. When would you use it?",
        "What is scan insertion? Explain the scan chain stitching process.",
        "How do you handle clock domain crossing in scan chains?",
        "What is JTAG boundary scan? When and why would you use it?",
        "Your scan chains have hold violations. What are common solutions?",
        "What is MBIST (Memory Built-In Self Test)? How does it work?",
        "Explain compression techniques in DFT. What is EDT (Embedded Deterministic Test)?",
        "What is the difference between internal scan and boundary scan?",
        "How do you handle mixed-signal blocks in DFT implementation?",
        "What is LBIST (Logic Built-In Self Test)? Compare LBIST vs external test.",
        "Describe test pattern generation flow. What tools and steps are involved?",
        "How do you optimize for test time while maintaining coverage?",
        "What are the key DFT verification checks before tape-out?"
    ]
}
...
def analyze_answer_quality(question, answer, topic):
    ...
    scoring_criteria = {
        ...
        'dft': {
            'excellent_terms': ['scan chain', 'atpg', 'fault coverage', 'stuck-at', 'transition delay', 'scan insertion', 'jtag', 'mbist', 'lbist', 'compression', 'edt'],
            'good_terms': ['dft', 'test', 'scan', 'fault', 'boundary', 'pattern', 'coverage', 'built-in', 'verification'],
            'methodology_terms': ['systematic', 'approach', 'method', 'technique', 'optimization', 'flow']
        }
    }
    ...
    <div class="container">
        ...
        <div class="info-card">
            ...
            <div class="credentials">
                <strong>Engineers:</strong> eng001 through eng021<br>
                <strong>Password:</strong> password123<br>
                <strong>Admin:</strong> admin / Vibhuaya@3006
            </div>
            <div class="eng-list">
                <strong>21 Engineers:</strong><br>
                ...
                <strong>DFT Team:</strong> Anbu • Shama • Kiran
            </div>
        </div>
    </div>
</body>
...
# app.py (Part 2 - Updated with DFT additions)
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div style="color: #64748b;">
                ...
                <p>• <strong>72 Questions total</strong> across STA, CTS, Signoff, and DFT</p>
                <p>• <strong>21 Engineers</strong> including specialized DFT team</p>
...
if __name__ == '__main__':
    try:
        ...
        print("✅ 21 Engineers loaded (18 + 3 DFT)")
        print("✅ 72 Questions loaded (STA, CTS, Signoff, DFT)")
        ...
        print("👥 Engineers: eng001-eng021 / password123")

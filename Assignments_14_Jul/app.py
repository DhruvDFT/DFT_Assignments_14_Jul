...
def student_test(test_id):
    ...
    if request.method == 'POST' and test['status'] == 'pending':
        ...
        min_required = max(12, int(num_questions * 0.8))  # At least 80% or 12, whichever is higher
    ...
    min_required = max(12, int(num_questions * 0.8))
    ...
    for i, q in enumerate(test['questions']):
        ...
        <div class="question-card">
            <div class="question-header">
                <span class="question-number">Question {i+1} of {num_questions}</span>
...
<body>
    ...
    <div class="container">
        ...
        <div class="test-info">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-top: 20px;">
                <div><strong>Questions:</strong> {num_questions} Technical</div>
                <div><strong>Max Points:</strong> {max_score} (10 each)</div>
            ...
            <div id="progressText">Progress: 0/{num_questions} questions answered</div>
        </div>
        ...
        <form method="POST" id="assessmentForm">
            ...
            <div class="submit-section">
                <div class="{'urgent-warning' if is_urgent else 'warning'}">
                    {'🚨 URGENT: Less than 24 hours remaining! Submit immediately or lose access!' if is_urgent else f'⚠️ DEADLINE ENFORCEMENT: Test will be automatically locked after 2 days. Minimum {min_required} answers required!'}
                </div>
    ...
    <script>
        ...
        function updateProgress() {{
            ...
            const percentage = (answered / numQuestions) * 100;
            
            progressBar.style.width = percentage + '%';
            progressText.textContent = `Progress: ${{answered}}/${{numQuestions}} questions answered`;
            
            // Enable submit button if minimum answers provided
        ...
        document.getElementById('assessmentForm').addEventListener('submit', function(e) {{
            ...
            if (answered < minRequired) {{
                e.preventDefault();
                alert(`Please answer at least ${{minRequired}} questions (minimum 20 characters each) before submitting.`);
                return false;
            }}
...
if __name__ == '__main__':
    try:
        ...
        print("✅ 105 Questions loaded (STA, CTS, Signoff, Synthesis, 3 DFT specializations)")
        ...
        print("🔧 DFT Specialists: Anbu (BIST), Shama (Scan), Kiran (Boundary)")
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div style="color: #64748b;">
                ...
                <p>• <strong>105 Questions total</strong> across STA, CTS, Signoff, Synthesis, and 3 DFT specializations</p>
                <p>• <strong>22 Engineers</strong> including DFT specialists and Synthesis expert</p>
...
def admin_review_list():
    ...
    for test in pending_tests:
        ...
        # Calculate max possible score based on questions
        ...
        <div class="review-card">
            ...
            <div class="review-meta">
                ...
                <div class="meta-item">📊 Estimated Total: {int(avg_score * answered)}/{max_score}</div>
            </div>
...
<body>
        ...
        <form method="POST" id="reviewForm">
            ...
            <div class="submit-section">
                <div class="total-display">
                    <div class="total-score" id="totalScore">0/{max_score}</div>
    ...
    <script>
        ...
        function updateTotal() {{
            ...
            document.getElementById('totalScore').textContent = total + '/{max_score}';
        }}
    ...
    for test in my_tests:
        ...
        if status == 'completed':
            ...
            <div class="test-card completed">
                ...
                <div class="test-meta">✅ Completed | Score: {test.get("score", 0)}/{max_score} points</div>
            ...
            <div class="test-card submitted">
                <h3>📝 {test["topic"].upper()} Assessment</h3>
                <div class="test-meta">⏳ Under Review | {len(test["questions"])} Questions | Submitted: {test.get("submitted_date", "")[:10]}</div>
            ...
            <div class="test-card pending {urgency_class}">
                <h3>🎯 {test["topic"].upper()} Assessment</h3>
                <div class="test-meta">
                    📋 {len(test["questions"])} Questions | ⏰ {time_remaining} | 🎖️ Max: {max_score} points<br>
...
<head>
    ...
    <style>
        ...
        .test-card h3 {{ 
            color: #1e293b; 
            margin-bottom: 10px; 
            font-size: 20px;# app.py - Complete Railway-Ready Physical Design Assessment System
import os
import hashlib
...
def init_data():
    ...
    # 22 Engineers (18 original + 3 DFT + 1 Synthesis)
    engineer_data = [
        ('eng001', 'Kranthi'),
        ('eng002', 'Neela'),
        ('eng003', 'Bhanu'),
...
# Questions - 105 total across 7 topics
QUESTIONS = {
    "sta": [
    ...
    "dft_scan": [  # Shama - Scan Chain & ATPG Specialist
    ...
    "dft_bist": [  # Anbu - Built-In Self Test Specialist
    ...
    "dft_boundary": [  # Kiran - Boundary Scan & Advanced DFT Specialist
...
def create_test(eng_id, topic):
    ...
    # Each engineer gets all questions from their topic
    ...
    <div class="container">
        ...
        <div class="info-card">
            ...
            <div class="credentials">
                <strong>Engineers:</strong> eng001 through eng022<br>
                <strong>Password:</strong> password123<br>
                <strong>Admin:</strong> admin / Vibhuaya@3006
            </div>
            <div class="eng-list">
                <strong>22 Engineers:</strong><br>
                Kranthi • Neela • Bhanu • Lokeshwari • Nagesh • VJ<br>
                Pravalika • Daniel • Karthik • Hema • Naveen • Srinivas<br>
                Meera • Suraj • Akhil • Vikas • Sahith • Sravan<br>
                <strong>DFT Specialists:</strong> Anbu • Shama • Kiran<br>
                <strong>Synthesis:</strong> Pavan
            </div>
        </div>
    </div>
</body>
